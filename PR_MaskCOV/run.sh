...
CUDA_VISIBLE_DEVICES=2 python train_custom.py --data soybean_gene --use_maskcov --epoch 240 --backbone resnet50 --cls_2 --detail test --tb 8 --lr_scheduler cos_step --method 1 --small